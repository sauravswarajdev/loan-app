        ...
        <Col md={6} lg={4} className="mx-auto">
          <Card className="shadow-lg rounded-3">
            <Card.Body className="p-4">
              <h2 className="text-center mb-4" style={{ color: '#0d6efd', fontWeight: 'bold' }}>Login</h2>
              <Form style={{}}>
                ...
                <div className="mt-3 text-center" style={{marginTop:'5px'}}>
                  <a href="/forgot-password" style={{
                    color: '#0d6efd', textDecoration: 'none', marginLeft: '50px',
                  }}>Forgot Password?</a>
                </div>
              </Form>
            </Card.Body>
